...
<div class="video-wrapper">
  <iframe width="100%" height="400"
    src="https://www.youtube.com/embed/dci5rD8z2RA"
    title="GEIDA Foundation Training — Official Opening Session"
    frameborder="0"
...
**Slide deck:** [:material-file-pdf-box: Day 2 Deck 2 — GEIDA Introduction & Pathway](../assets/slides/Day2_Deck2_GEIDA_introduction_pathway.pdf)
...
<div class="video-wrapper">
  <iframe width="100%" height="400"
    src="https://www.youtube.com/embed/EVB2FzgwTLs"
    title="Introduction to WaPOR & hands-on exercise on field-level analysis"
    frameborder="0"
    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
    allowfullscreen>
  </iframe>
...
**Slide deck:** [:material-file-pdf-box: WaPOR Data History](../assets/slides/WaPOR_data_history.pdf)
...
Access: [data.apps.fao.org/wapor](https://data.apps.fao.org/wapor/?lang=en)

!!! note "WaPOR vs eToolkit"
...
2. Explored the ETa and root zone soil moisture (RZSM) time series for the area
...
!!! tip "Try WaPOR for your next agriculture or irrigation project"
...
*Continue to [Day 3 — Spatial Analysis & GeoLibre](../day-3/index.md)*
